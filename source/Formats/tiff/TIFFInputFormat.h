...
#ifndef __KTXTOOL_TIFF_INPUTFORMAT_INCLUDED
#define __KTXTOOL_TIFF_INPUTFORMAT_INCLUDED
...
class TIFFInputFormat : public InputFormat
{
public:
	...
	const char* GetName() const { return "TIFF - Tagged Image File Format"; }
